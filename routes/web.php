...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/registro_vacunas', [VacunaController::class, 'registro_vacunas'])->name('registro_vacunas');
    Route::get('/carnet_vacuna_pdf/{id}', [VacunaController::class, 'carnet_vacuna_pdf'])->name('carnet_vacuna_pdf');
